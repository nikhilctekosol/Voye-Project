...
export class ReservationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //  // Access the query parameters using the params object
    ...
    //    this.http.get('api/reservation/get-reservation?id=' + reservationid
    ...
    //          this.defaultPropertyId = this.reservation.propertyId;
    //          this.selectedPropertyName = this.reservation.property;
    //          localStorage["default-reservation-property"] = this.defaultPropertyId;
    //          localStorage["default-property-name"] = this.selectedPropertyName;
    //          this.loadProperty();
    //          this.filteredOptions$ = this.getFilteredOptions(this.selectedPropertyName);

    //          this.selectRoom(this.rooms.find(c => c.id = this.reservation.roomId))
    //        }
    ...
    //          this.isLoadingReservations = false;
    //          console.log('api/reservation/get-reservation', error)
    //          if (error.status === 401) {
